...
const MAP_CENTER = { lat: 50.8503, lng: 4.3517 }; // Coordonnées de Bruxelles (à remplacer par votre adresse)
const MAP_ZOOM = 15;
...
function initMap() {
    ...
    const infoWindow = new google.maps.InfoWindow({
        content: '<div style="padding: 10px;"><h3 style="margin: 0 0 5px 0; color: #8b4513;">Delicorner</h3><p style="margin: 0;">Votre adresse</p></div>'
    });
            ...
            mapContainer.innerHTML = `
                <div style="height: 100%; display: flex; align-items: center; justify-content: center; background: #f5f5f5; border-radius: 15px;">
                    <div style="text-align: center; padding: 2rem;">
                        ...
                        <p style="color: #999; font-size: 0.8rem; margin-top: 1rem;">Coordonnées: ${MAP_CENTER.lat}, ${MAP_CENTER.lng}</p>
                    </div>
                </div>
            `;
        }
